...
public class ConversationClient implements IConversationClient {
    ...
    public Comment createComment(Comment comment) {
        ...
        replyToComment.setReplyTo(comment.getReplyTo());
    ...
    @Override
    public Comment reactToComment(Comment comment, Reaction reaction) throws SettingsException, RequireUserException {
    ...
    public Comment voteOnComment(Comment comment, Vote vote) {
        return commentManager.vote(comment, vote);
    }

    @Override
    public Comment reportComment(Comment comment, ReportType reportType) {
        return commentManager.report(comment, reportType);
    }
