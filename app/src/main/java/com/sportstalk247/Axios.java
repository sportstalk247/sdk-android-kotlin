...
public class Axios {
     ...
     * log handler
     **/
    private final String TAG = Axios.class.getName();
    /**
    ...
    public Axios(Context context, String httpMethod, String url, Map<String, String> apiHeaders, Map<String, String> data, APICallback apiCallback) {
